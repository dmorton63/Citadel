...
namespace QG
{
    ...
    namespace
    {
        ...
        inline Glyph5x7 glyphForChar(char c)
        {
            ...
            case '#':
                return {{0x0A, 0x0A, 0x1F, 0x0A, 0x1F, 0x0A, 0x0A}};
            case '$':
                return {{0x04, 0x0F, 0x14, 0x0E, 0x05, 0x1E, 0x04}};
            case '%':
                return {{0x19, 0x19, 0x02, 0x04, 0x08, 0x13, 0x13}};
            case '&':
                return {{0x0C, 0x12, 0x14, 0x08, 0x15, 0x12, 0x1D}};
            case '\'':
            ...
            case ';':
                return {{0x00, 0x04, 0x00, 0x00, 0x04, 0x04, 0x02}};
            case '<':
            ...
            case '@':
                return {{0x0E, 0x11, 0x1D, 0x15, 0x1D, 0x01, 0x0E}};
            case '/':
            ...
            case '`':
                return {{0x02, 0x04, 0x08, 0x00, 0x00, 0x00, 0x00}};
            case '(':
            ...
            case '{':
                return {{0x08, 0x04, 0x04, 0x02, 0x04, 0x04, 0x08}};
            case '|':
                return {{0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04}};
            case '}':
                return {{0x02, 0x04, 0x04, 0x08, 0x04, 0x04, 0x02}};
            case '~':
                return {{0x00, 0x00, 0x09, 0x16, 0x00, 0x00, 0x00}};
            case '=':
