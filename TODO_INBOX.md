...
- [x] Item 31: Expand QCQL schema support so desktop data can use normalized relational tables (layout, controls, bindings, themes, capabilities) instead of chunk-style payload storage.
