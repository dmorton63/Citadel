...
- [X] Add ImGui to project:
  - [X] Download ImGui from GitHub
  - [X] Add ImGui source files to project
  - [X] Set up Dear ImGui backends (Win32 + DX11/OpenGL)
  - [X] Create basic window and rendering loop
- [X] Create main application window:
  - [X] Menu bar (File, Database, Query, View, Help)
  - [X] Status bar (show DB path, table count, page count)
  - [X] Dockable layout
- [X] **Milestone:** ImGui window opens and renders basic UI
...
### UI for Milestone 1
- [ ] File menu: New Database, Open Database, Close Database
- [ ] Database inspector window:
  - [ ] Show FileHeader details (magic, version, pageSize, tableCount)
  - [ ] Display page region info
- [ ] Page viewer window:
  - [ ] List all allocated pages
  - [ ] Show PageHeader for selected page
  - [ ] Hex dump of page contents
- [ ] **UI Milestone:** Visualize DB structure and pages in real-time
...
- [ ] Schema browser window:
  ...
  - [ ] Show column details (name, type, isPrimaryKey)
  - [ ] Table properties (rootPage, flags, rowCount estimate)
- [ ] Schema validation panel:
  - [ ] Visual indication of schema issues
  - [ ] Primary key highlighting
- [ ] **UI Milestone:** Browse database schema visually
...
### UI for Milestone 3
- [ ] Table data viewer:
  - [ ] Grid view of table contents
  - [ ] Show all columns and rows
  - [ ] Tombstone indicators (strikethrough or red text)
- [ ] Row editor:
  - [ ] Form-based row insertion
  - [ ] Type-appropriate input widgets (text, int, bool, datetime)
  - [ ] Validation feedback
- [ ] Page utilization visualizer:
  - [ ] Bar chart showing page fill percentage
  - [ ] Free space indicators
- [ ] **UI Milestone:** Insert and view data through the GUI
...
### UI for Milestone 4
- [ ] Primary key index viewer:
  - [ ] List all PK index entries
  - [ ] Show (key, pageId, rowOffset) tuples
  - [ ] Sort indicator
- [ ] Query performance panel:
  - [ ] Show query execution time
  - [ ] Index vs. full scan indicator
  - [ ] Number of pages loaded
- [ ] Search bar:
  - [ ] Quick PK lookup input
  - [ ] Jump to row in table viewer
- [ ] **UI Milestone:** Visualize index structure and query performance
...
- [ ] CRUD operations panel:
  - [ ] Buttons: Insert, Update, Delete, Refresh
  - [ ] Permission indicator (read/write/delete/admin)
  - [ ] Operation result feedback (success/error)
- [ ] Row detail editor:
...
- [ ] Bulk operations:
  - [ ] Import CSV data
  - [ ] Export table to CSV
- [ ] **UI Milestone:** Full CRUD through GUI with permission awareness
...
- [ ] Boot sequence visualizer:
  - [ ] Progress indicator for each boot phase
  - [ ] Log window showing boot steps
  - [ ] Error/warning display
- [ ] System tables viewer:
  - [ ] Separate tab for Themes, ThemeTokens, Capabilities
  - [ ] System table indicator (lock icon or different color)
  - [ ] Read-only mode for system tables
- [ ] First-boot wizard:
  - [ ] Guided setup for new database
  - [ ] System table creation confirmation
- [ ] **UI Milestone:** Visualize boot process and system table management
...
### UI for Milestone 7
- [ ] SQL Query window:
  - [ ] Multi-line text editor for CQL queries
...
- [ ] **UI Milestone:** Execute text queries through GUI
...
### UI for Milestone 8
- [ ] Security panel:
  - [ ] Show current DbHandle details
  - [ ] List table permissions for current handle
  - [ ] Capability viewer (read/write/delete/admin per table)
- [ ] Process binding indicator:
  - [ ] Show which process/service is connected
  - [ ] Handle revocation button (for testing)
- [ ] Access log viewer:
  - [ ] Real-time log of CQL operations
  - [ ] Filter by table, operation, result
  - [ ] Export log to file
- [ ] **UI Milestone:** Visualize security model and access control
...
- [ ] Theme editor:
  ...
  - [ ] Token editor (color picker for Accent, Background, etc.)
  - [ ] Live preview of changes
  - [ ] Save to CQL button
- [ ] ThemeService integration panel:
  - [ ] Show loaded theme
  - [ ] List all ThemeTokens for current theme
  - [ ] CitadelStyle visualization
- [ ] Theme management:
  - [ ] Create new theme
  - [ ] Clone existing theme
  - [ ] Delete theme
- [ ] **UI Milestone:** Full theme management through CQL
...
- [ ] WAL viewer:
  - [ ] List WAL frames
  - [ ] Show pending vs. checkpointed frames
  - [ ] Checkpoint progress indicator
- [ ] Recovery panel:
  - [ ] Recovery log on boot
  - [ ] Show recovered operations
  - [ ] Database consistency status
- [ ] Transaction simulator:
  - [ ] Start/commit/rollback buttons
  - [ ] Crash simulator (for testing recovery)
- [ ] Durability monitor:
  - [ ] Fsync status
  - [ ] Write-ahead log size
  - [ ] Last checkpoint time
- [ ] **UI Milestone:** Visualize durability and recovery mechanisms
...
- [ ] Add ImGui to project:
  - [ ] Clone ImGui from https://github.com/ocornut/imgui
  - [ ] Add these files to project:
    - [ ] `imgui.cpp`, `imgui.h`
    - [ ] `imgui_demo.cpp`
    - [ ] `imgui_draw.cpp`
    - [ ] `imgui_tables.cpp`
    ...
    - [ ] `backends/imgui_impl_dx11.cpp/.h` (or OpenGL)
- [ ] Set up rendering:
  - [ ] Initialize DirectX 11 or OpenGL context
  - [ ] Create swap chain and render target
  - [ ] Initialize ImGui context
  - [ ] Set up Win32 window procedure

### Core UI Components
- [ ] Main application frame:
  - [ ] Menu bar with File, Edit, View, Database, Query, Tools, Help
  - [ ] Dockspace for flexible window layout
  - [ ] Status bar showing connection info
- [ ] Reusable widgets:
  - [ ] Table grid widget (for displaying query results)
  - [ ] Hex viewer widget (for page inspection)
  - [ ] Tree view widget (for schema browser)
  - [ ] Log window widget (for operation logs)

### Window Management
- [ ] Implement dockable windows:
  - [ ] Database Inspector
  - [ ] Schema Browser
  - [ ] Table Data Viewer
  - [ ] Query Editor
...
### Visual Polish
- [ ] Styling:
  - [ ] Choose ImGui style (Dark, Light, Classic, or custom)
  - [ ] Consistent color scheme
  - [ ] Icons for common operations (optional, using FontAwesome)
- [ ] Feedback mechanisms:
